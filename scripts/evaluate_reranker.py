...
async def main():
    ...
    for index, item in enumerate(
        ...
        # ------------------------------------------
        # Stage 2: Prepare documents for reranker
        # ------------------------------------------
        ...
        # ------------------------------------------
        # Map reranked indexes back to nodes
        # ------------------------------------------
        ...
        for rank, result in enumerate(
            ...
            source = original_result.node.metadata.get(
                "file_name"
            )
    ...
    print("\n")
    print("=" * 60)
    print("FINAL RERANKED RETRIEVAL EVALUATION")
    print("=" * 60)
